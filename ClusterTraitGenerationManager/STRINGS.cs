                    ...
                    public class FOOTER
                    {
                        ...
                        public class BUTTONS
                        {
                            ...
                            public class GENERATECLUSTERBUTTON
                            {
                                ...
                                public static LocString TOOLTIP_CLUSTERPLACEMENTFAILED_ASTEROID = "The current asteroid placement rules for the {0} currently fail to place the asteroid.\nPlease adjust your its placements or reduce the total amount of asteroids.";
