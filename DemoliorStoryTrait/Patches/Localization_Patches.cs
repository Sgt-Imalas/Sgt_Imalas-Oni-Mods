...
namespace DemoliorStoryTrait.Patches
{
	class Localization_Patches
	{
		...
		public class Localization_Initialize_Patch
		{
			...
			{
				string pipmolior_name = global::STRINGS.UI.SPACEDESTINATIONS.CLUSTERMAPMETEORS.LARGEIMACTOR.NAME;
				string pipmolior_uppercase_name = global::STRINGS.MISC.NOTIFICATIONS.INCOMINGPREHISTORICASTEROIDNOTIFICATION.NAME;
