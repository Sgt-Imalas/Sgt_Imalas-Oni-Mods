...
namespace BioluminescentDupes.Content.UI
{
	internal class Bioluminescence_Sidescreen
	{
		...
		public static BioluminescenceColorSelectable Target
		{
			get
			{
				return _target;
		...
		private static BioluminescenceColorSelectable _target;
