...
namespace RocketryExpanded
{
    ...
    public class HabitatModuleLongConfig : IBuildingConfig
    {
        public const string ID = "HabitatModuleLong";
        public const string DisplayName = "LONGE HABITAT";
        ...
        public override void ConfigureBuildingTemplate(GameObject go, Tag prefab_tag)
        {
            ...
            go.AddOrGet<ClustercraftExteriorDoor>().interiorTemplateName = "interiors/habitat_long";
