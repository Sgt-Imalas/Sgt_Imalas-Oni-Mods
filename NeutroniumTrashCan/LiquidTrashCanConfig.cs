...
{
	internal class LiquidTrashCanConfig : IBuildingConfig
	{
		public const string ID = "NTC_LiquidTrashCan";
		...
		public override void DoPostConfigureComplete(GameObject go) => go.AddOrGet<NeutroniumTrashCan>().tint = Color.blue;
	}
}
