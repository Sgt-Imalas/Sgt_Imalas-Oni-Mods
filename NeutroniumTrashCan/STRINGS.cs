	...
	internal class STRINGS
	{
		...
		public class BUILDINGS
		{
			public class PREFABS
			{
				...
				{
					public static LocString NAME = global::STRINGS.UI.FormatAsLink("Artifact Trash Can", nameof(NTC_ARTIFACTTRASHCAN));
				...
				{
					public static LocString NAME = global::STRINGS.UI.FormatAsLink("Neutronium Trash Can", nameof(NTC_NEUTRONIUMTRASHCAN));
					public static LocString DESC = "Its bigger on the inside!";
				...
				{
					public static LocString NAME = global::STRINGS.UI.FormatAsLink("Gas Trash Can", nameof(NTC_GASTRASHCAN));
					public static LocString DESC = "Its bigger on the inside!";
				...
				{
					public static LocString NAME = global::STRINGS.UI.FormatAsLink("Solid Trash Can", nameof(NTC_SOLIDTRASHCAN));
					public static LocString DESC = "Its bigger on the inside!";
				...
				{
					public static LocString NAME = global::STRINGS.UI.FormatAsLink("Liquid Trash Can", nameof(NTC_LIQUIDTRASHCAN));
					public static LocString DESC = "Its bigger on the inside!";
