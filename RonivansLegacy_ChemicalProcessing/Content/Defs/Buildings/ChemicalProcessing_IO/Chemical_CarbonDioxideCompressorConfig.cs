...
namespace Dupes_Industrial_Overhaul.Chemical_Processing.Buildings
{
	public class Chemical_CarbonDioxideCompressorConfig : IBuildingConfig
	{
		...
		public override BuildingDef CreateBuildingDef()
		{
			...
			BuildingDef buildingDef = BuildingTemplates.CreateBuildingDef(ID, 3, 3, "co2_compressor_kanim", 30, 10f, construction_mass, construction_materials, 800f, BuildLocationRule.OnFloor, TUNING.BUILDINGS.DECOR.PENALTY.TIER1, tieR0);
			...
			SoundUtils.CopySoundsToAnim("co2_compressor_kanim", "airconditioner_kanim");
			return buildingDef;
		}
