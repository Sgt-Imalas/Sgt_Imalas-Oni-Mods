...
{
	public class Chemical_ChlorineCompressorConfig : IBuildingConfig
	{

		public static string ID = "Chemical_ChlorineCompressor";
		...
		public override BuildingDef CreateBuildingDef()
		{
			...
			BuildingDef buildingDef = BuildingTemplates.CreateBuildingDef(ID, 3, 3, "chlorine_compressor_kanim", 30, 10f, construction_mass, construction_materials, 800f, BuildLocationRule.OnFloor, TUNING.BUILDINGS.DECOR.PENALTY.TIER1, tieR0);
			...
			SoundUtils.CopySoundsToAnim("chlorine_compressor_kanim", "airconditioner_kanim");
			return buildingDef;
		}
		...
		public override void ConfigureBuildingTemplate(GameObject go, Tag prefab_tag)
		{
			...
			conduitConsumer.capacityTag = SimHashes.ChlorineGas.CreateTag();
			conduitConsumer.forceAlwaysSatisfied = true;
			conduitConsumer.wrongElementResult = ConduitConsumer.WrongElementResult.Dump;

			ElementConverter elementConverter = go.AddOrGet<ElementConverter>();
			elementConverter.consumedElements = [new ElementConverter.ConsumedElement(SimHashes.ChlorineGas.CreateTag(), 1f)];
			elementConverter.outputElements = [new ElementConverter.OutputElement(1f, SimHashes.Chlorine, 212.15f, storeOutput: true)];

			PipedConduitDispenser conduitDispenser = go.AddOrGet<PipedConduitDispenser>();
			conduitDispenser.conduitType = ConduitType.Liquid;
			conduitDispenser.storage = defaultStorage;
			conduitDispenser.elementFilter = [SimHashes.Chlorine];
