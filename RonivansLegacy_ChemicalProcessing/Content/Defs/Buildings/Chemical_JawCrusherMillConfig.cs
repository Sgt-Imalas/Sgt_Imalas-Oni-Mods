...
namespace Dupes_Industrial_Overhaul.Chemical_Processing.Buildings
{
	...
	public class Chemical_SmallCrusherMillConfig : IBuildingConfig
	{
		...
		public override BuildingDef CreateBuildingDef()
		{
			...
			BuildingDef buildingDef = BuildingTemplates.CreateBuildingDef(ID, 3, 2, "jawcrusher_mill_kanim", 100, 30f, BUILDINGS.CONSTRUCTION_MASS_KG.TIER3, MATERIALS.ALL_METALS, 800f, BuildLocationRule.OnFloor, BUILDINGS.DECOR.PENALTY.TIER1, tier, 0.2f);
		...
		private void ConfigureRecipes()
		{
			...
			.Description1I3O(CHEMICAL_COMPLEXFABRICATOR_STRINGS.JAWCRUSHERMILL_MILLING_1_3)
			.NameDisplay(ComplexRecipe.RecipeNameDisplay.IngredientToResult)
			.Build();
			...
			RecipeBuilder.Create(ID, 40)
					...
					.Output(SimHashes.Sand, 50f, ComplexRecipe.RecipeElement.TemperatureOperation.Heated)
					.Description1I1O(CHEMICAL_COMPLEXFABRICATOR_STRINGS.JAWCRUSHERMILL_MILLING_1_2)
					.NameDisplay(ComplexRecipe.RecipeNameDisplay.Ingredient)
					.Build();
