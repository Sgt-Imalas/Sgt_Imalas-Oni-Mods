...
namespace RonivansLegacy_ChemicalProcessing.Content.Defs.Buildings.HighPressureApplications.HPA_liquid
{
    class HPAFilterLiquidConfig : IBuildingConfig
	{
		public const string ID = "HPA_MultiLiquidFilter";
		...
		public override BuildingDef CreateBuildingDef()
		{
			...
			BuildingDef buildingDef = BuildingTemplates.CreateBuildingDef(ID, 3, 1, "hpa_filter_liquid_kanim", 30, 10f, construction_mass, construction_materials, 1600f, BuildLocationRule.Anywhere, tieR0, noise);
			...
			SoundUtils.CopySoundsToAnim("hpa_filter_liquid_kanim", "filter_liquid_kanim");
			return buildingDef;
		}
