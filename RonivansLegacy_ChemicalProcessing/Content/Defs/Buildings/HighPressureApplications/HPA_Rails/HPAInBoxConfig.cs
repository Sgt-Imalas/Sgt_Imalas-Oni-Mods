...
namespace RonivansLegacy_ChemicalProcessing.Content.Defs.Buildings.HighPressureApplications.HighCapacityLogisticRails
{
    class HPAInBoxConfig : IBuildingConfig, IHasConfigurableStorageCapacity, IHasConfigurableWattage
	{
		...
		public static float StorageCapacity = HighPressureConduitRegistration.GetLogisticConduitMultiplier() * 1000; //10 tons at default
		...
		public override BuildingDef CreateBuildingDef()
		{
			...
			BuildingDef buildingDef = BuildingTemplates.CreateBuildingDef(ID, 3, 2, "conveyorin_kanim", 100, 60f, tieR3, refinedMetals, 1600f, BuildLocationRule.Anywhere, tieR1, noise);
