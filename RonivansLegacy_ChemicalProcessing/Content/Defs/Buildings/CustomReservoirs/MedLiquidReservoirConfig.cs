...
namespace RonivansLegacy_ChemicalProcessing.Content.Defs.Buildings.CustomReservoirs
{
	class MedLiquidReservoirConfig : IBuildingConfig, IHasConfigurableStorageCapacity
	{
		...
		public PortDisplayInput SecondaryInputPort = new(ConduitType.Liquid,new CellOffset(1,3));
		public PortDisplayOutput PrimaryOutputPort = new (ConduitType.Liquid,new CellOffset(-1,0));
		public PortDisplayOutput SecondaryOutputPort = new(ConduitType.Liquid,new CellOffset(1,0));
