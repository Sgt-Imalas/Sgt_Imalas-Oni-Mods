...
{
	class SmallGasReservoirWallConfig : IBuildingConfig, IHasConfigurableStorageCapacity
	{
		static float StorageCapacity = 250f * 0.6f; //visually 60% of small gas reservoir; 150
		...
		{
			BuildingDef def = BuildingTemplates.CreateBuildingDef(ID, Width, Height, KANIM, 50, 60f, [80], MATERIALS.ALL_METALS, 800f, buildLocationRule, TUNING.BUILDINGS.DECOR.PENALTY.TIER1, TUNING.NOISE_POLLUTION.NOISY.TIER0);
