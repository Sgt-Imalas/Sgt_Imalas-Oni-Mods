...
{
    class WoodMeshTileConfig : IBuildingConfig
	{
		public static string ID = "WoodenMeshTile";

		public override BuildingDef CreateBuildingDef()
		{
			string kanim = "floor_wooden_wmesh_kanim";
			float[] mass = [50,50];
			...
			AssetUtils.AddCustomTileAtlas(def, "tiles_wooden_wmesh", false, "tiles_solid");
