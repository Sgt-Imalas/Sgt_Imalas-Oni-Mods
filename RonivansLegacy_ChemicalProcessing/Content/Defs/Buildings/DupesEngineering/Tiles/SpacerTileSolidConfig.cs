...
{
    class SpacerTileSolidConfig : IBuildingConfig
	{
		public static string ID = "SpacerTileSolid";

		public override BuildingDef CreateBuildingDef()
		{
			string kanim = "floor_spacer_solid_kanim";
			float[] mass = [95, 5];
			string[] cost = [GameTags.BuildableRaw.ToString(),GameTags.RefinedMetal.ToString()];
			...
			AssetUtils.AddCustomTileAtlas(def, "tiles_spacer", false, "tiles_solid");
			AssetUtils.AddCustomTileTops(def, "tiles_spacer_tops", false, "tiles_bunker_tops_decor_info");
