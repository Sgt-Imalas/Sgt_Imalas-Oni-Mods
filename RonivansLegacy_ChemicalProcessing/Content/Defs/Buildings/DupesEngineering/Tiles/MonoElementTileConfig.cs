...
namespace RonivansLegacy_ChemicalProcessing.Content.Defs.Buildings.DupesEngineering.Tiles
{
	class MonoElementTileConfig : IBuildingConfig
	{
		...
		public override BuildingDef CreateBuildingDef()
		{
			...
			BuildingDef def = BuildingTemplates.CreateBuildingDef(ID, 1, 1, kanim, 100, 5f, [300], cost, 1600f, BuildLocationRule.Tile, BUILDINGS.DECOR.BONUS.TIER1, NOISE_POLLUTION.NONE);
		...
		public override void ConfigureBuildingTemplate(GameObject go, Tag tag)
		{
			...
			go.AddOrGet<KAnimGridTileVisualizer>().blockTileConnectorID = Hash.SDBMLower("tiles_bunker_tops");
