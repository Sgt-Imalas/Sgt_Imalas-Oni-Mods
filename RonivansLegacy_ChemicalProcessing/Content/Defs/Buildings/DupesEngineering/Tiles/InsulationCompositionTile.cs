...
{
    class InsulationCompositionTileConfig : IBuildingConfig
	{
		public static string ID = "InsulationCompositionTile";
		public override BuildingDef CreateBuildingDef()
		{
			...
			AssetUtils.AddCustomTileAtlas(def, "tiles_insulating", false, "tiles_solid");
			AssetUtils.AddCustomTileTops(def, "tiles_insulating_tops", false, "tiles_bunker_tops_decor_info");
