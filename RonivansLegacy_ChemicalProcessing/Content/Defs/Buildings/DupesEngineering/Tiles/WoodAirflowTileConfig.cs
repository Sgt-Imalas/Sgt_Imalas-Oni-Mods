...
{
    class WoodAirflowTileConfig : IBuildingConfig
	{
		public static string ID = "WoodenGasTile";

		public override BuildingDef CreateBuildingDef()
		{
			string kanim = "floor_Wooden_gasperm_kanim";
			float[] mass = [50,50];
			...
			AssetUtils.AddCustomTileAtlas(def, "tiles_wooden_gasperm", false, "tiles_solid");
