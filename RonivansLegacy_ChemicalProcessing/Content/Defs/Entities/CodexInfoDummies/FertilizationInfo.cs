...
namespace RonivansLegacy_ChemicalProcessing.Content.Defs.Entities.CodexInfoDummies
{
	...
	internal class FertilizationInfo : IEntityConfig
	{
		...
		{
			GameObject go = EntityTemplates.CreateLooseEntity(ID, global::STRINGS.UI.FormatAsLink(global::STRINGS.CREATURES.STATS.FERTILIZATION.NAME, FarmStationConfig.ID), global::STRINGS.ITEMS.INDUSTRIAL_PRODUCTS.FARM_STATION_TOOLS.DESC, 1f, true, Assets.GetAnim((HashedString)"kit_planttender_kanim"), "object", Grid.SceneLayer.Front, EntityTemplates.CollisionShape.RECTANGLE, 0.8f, 0.6f, false);
