...
namespace BawoonFwiend
{
  ...
  IGameObjectEffectDescriptor

    {
        ...
        public static float BloongasUsage = 2f;
          ...
          GameStateMachine<Bawoongiver.States, Bawoongiver.StatesInstance, Bawoongiver>
        {
            ...
            public override void InitializeStates(out StateMachine.BaseState default_state)
            {
                ...
                this.ready.idle.PlayAnim("on", KAnim.PlayMode.Loop).WorkableStartTransition((Func<Bawoongiver.StatesInstance, Workable>)(smi => (Workable)smi.master.GetComponent<BawoongiverWorkable>()), this.ready.working).Transition(this.operational, GameStateMachine<Bawoongiver.States, Bawoongiver.StatesInstance, Bawoongiver, object>.Not(new StateMachine<Bawoongiver.States, Bawoongiver.StatesInstance, Bawoongiver, object>.Transition.ConditionCallback(this.IsReady))).EventTransition(GameHashes.OnStorageChange, this.operational, GameStateMachine<Bawoongiver.States, Bawoongiver.StatesInstance, Bawoongiver, object>.Not(new StateMachine<Bawoongiver.States, Bawoongiver.StatesInstance, Bawoongiver, object>.Transition.ConditionCallback(this.IsReady)));
                this.ready.working.PlayAnim("working_pre").QueueAnim("working_loop", true).WorkableStopTransition((Func<Bawoongiver.StatesInstance, Workable>)(smi => (Workable)smi.master.GetComponent<BawoongiverWorkable>()), this.ready.post);
