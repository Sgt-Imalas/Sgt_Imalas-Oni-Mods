...
{
	internal class ModIntegration_Patches
	{
		public class Rocketry_Interior_WeightLimit
		{
			public static class RocketInteriorWeightLimitApi
			{
				...
				public static bool TryInitialize(bool logWarnings = true)
				{
					...
					{
						if (logWarnings)
							SgtLogger.l("RocketryRework.ModMisc.ModAPI does not exist.");
					...
					{
						if (logWarnings) Debug.LogWarning("AddMassLimitConditionToHabitatModule is not a valid method.");
						return false;
					}
