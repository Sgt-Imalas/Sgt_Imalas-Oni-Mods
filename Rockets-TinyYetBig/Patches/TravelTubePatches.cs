...
//                {
//                        new NavGrid.Transition(NavType.Tube, NavType.Tube, 0, 3, NavAxis.NA, true, false, false, 17, "", new CellOffset[0],
//                        new CellOffset[]{
//                            new CellOffset( 0, 1)
//                            ,new CellOffset( 0, 2)
//                        }
//                        , new NavOffset[]
//                        {
//                            new NavOffset(NavType.Tube, 0, 3)
...
//                {
//                    SgtLogger.l(transition.ToString() + " cost: " + transition.cost);
//                }
