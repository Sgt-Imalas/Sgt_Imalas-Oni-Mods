...
namespace Rockets_TinyYetBig.TwitchEvents.TwitchEventAddons
{
    internal class ImposterConfig : IEntityConfig
    {
        ...
        public GameObject CreatePrefab()
        {
            ...
            Db.Get().CreateTrait(imposta_trait, name1, name1, (string)null, false, (ChoreGroup[])null, true, true).Add(new AttributeModifier(Db.Get().Amounts.HitPoints.maxAttribute.Id, 80f, name1));
