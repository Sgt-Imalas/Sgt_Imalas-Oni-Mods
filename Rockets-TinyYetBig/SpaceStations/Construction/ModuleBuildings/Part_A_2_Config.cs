...
{
	public class Part_A_2_Config : IBuildingConfig
	{
		public const string ID = "RTB_Part_A_2";
		...
		public override BuildingDef CreateBuildingDef()
		{
			...
			buildingDef.AttachmentSlotTag = ModuleParts_Central.RTB_Part_A_1;
		...
		public override void ConfigureBuildingTemplate(GameObject go, Tag prefab_tag)
		{
			...
			{
				new BuildingAttachPoint.HardPoint(new CellOffset(0, 5),ModuleParts_Central.RTB_Part_A_2, (AttachableBuilding) null)
			};
		}
