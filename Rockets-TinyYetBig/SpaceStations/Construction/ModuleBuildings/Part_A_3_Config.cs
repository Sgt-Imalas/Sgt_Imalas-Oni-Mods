...
namespace Rockets_TinyYetBig.SpaceStations.Construction.ModuleBuildings
{
	public class Part_A_3_Config : IBuildingConfig
	{
		...
		public override BuildingDef CreateBuildingDef()
		{
			...
			buildingDef.AttachmentSlotTag = ModuleParts_Central.RTB_Part_A_2;
		...
		public override void ConfigureBuildingTemplate(GameObject go, Tag prefab_tag)
		{
			...
			{
				new BuildingAttachPoint.HardPoint(new CellOffset(0, 5), ModuleParts_Central.RTB_Part_A_3, (AttachableBuilding) null)
			};
		}
