...
{
	public class LoaderFirepoleAdapterConfig : IBuildingConfig
	{
		public const string ID = "RTB_FirepoleConnectionAdapter";
		...
		public override BuildingDef CreateBuildingDef()
		{
			...
			BuildingDef buildingDef = BuildingTemplates.CreateBuildingDef(
					...
					1,
					2,
					"rocket_loader_extension_firepole_kanim",
					200,
					40f,
					MaterialCosts,
					Materials,
		...
		public override void ConfigureBuildingTemplate(GameObject go, Tag prefab_tag)
		{
			...
			ladder.downwardsMovementSpeedMultiplier = 4;
			...
			go.AddOrGet<FirePoleAdapter_AnimTileable>();
		}
