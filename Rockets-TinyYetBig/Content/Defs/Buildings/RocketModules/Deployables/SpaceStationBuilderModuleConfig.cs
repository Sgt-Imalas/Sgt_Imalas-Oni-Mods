...
namespace Rockets_TinyYetBig.SpaceStations
{
	class SpaceStationBuilderModuleConfig : IBuildingConfig
	{
		...
		{
			var attachment = go.AddComponent<RocketAttachableSocket>();
			attachment.AttachmentOffset = new CellOffset(0, 1);
			attachment.AttachmentTag = ModAssets.Tags.AttachmentSlotStationParts;
