...
namespace Rockets_TinyYetBig.Buildings.Boosters
{
    public class IonEngineBoosterClusterConfig : IBuildingConfig, ISaveLoadable
    {
        ...
        {
            UtilMethods.CopySoundsToAnim(kanim, "rocket_cluster_hydrogen_engine_kanim");
        ...
        public override void DoPostConfigureComplete(GameObject go)
        {
            ...
            BuildingTemplates.ExtendBuildingToRocketModuleCluster(go, null, ROCKETRY.BURDEN.MODERATE_PLUS, 20, 0);
