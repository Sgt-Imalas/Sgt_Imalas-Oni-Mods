...
{
    class ConveyorLiftConfig : IBuildingConfig
	{
		public const string ID = "CT_ConveyorLift";
		...
		public override void DoPostConfigureComplete(GameObject go)
		{
			...
			go.AddOrGet<ConveyorTileSM>().Mode = ConveyorTileSM.ConveyorTileMode.Vertical;
