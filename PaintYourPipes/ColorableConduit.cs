...
namespace PaintYourPipes
{
	...
	internal class ColorableConduit : KMonoBehaviour, ISidescreenButtonControl
	{
		...
		public static void Blueprints_SetData(GameObject source, JObject data)
		{
			...
			{
				var t1 = data.GetValue("colorHex");
				if (t1 == null)
					return;
				var colorHex = t1.Value<string>(); //"Value1"

				var t2 = data.GetValue("secondaryColorHex");
				if (t2 == null)
					return;
		...
		public void SetColorHexValues(string colorHex, string secondaryColorHex)
		{
