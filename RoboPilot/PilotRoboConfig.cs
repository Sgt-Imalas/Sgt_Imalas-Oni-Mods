...
namespace RoboPilot
{
    class PilotRoboConfig : IEntityConfig
    {
        ...
        //    public const float BATTERY_DEPLETION_RATE = 17.14286f;
        //    public const float MASS = 100f;
        //    private const float WIDTH = 1f;
        //    private const float HEIGHT = 2f;
        //    private string name = "Robo pilot";
        //    private string desc = "tba.";
        ...
        //        double mass = (double)PilotRoboConfig.MASS;
        //        EffectorValues none = TUNING.BUILDINGS.DECOR.NONE;
        //        KAnimFile anim = Assets.GetAnim((HashedString)"scout_bot_kanim");
        //        EffectorValues decor = none;
        //        EffectorValues noise = new EffectorValues();
        //        GameObject placedEntity = EntityTemplates.CreatePlacedEntity("PilotRobo", name, desc, (float)mass, anim, "idle_loop", Grid.SceneLayer.Creatures, 1, 2, decor, noise);
        ...
        //        component2.initialTraits.Add(PilotRoboConfig.ROVER_BASE_TRAIT_ID);
        //        component2.initialAmounts.Add(Db.Get().Amounts.HitPoints.Id);
        //        component2.initialAmounts.Add(Db.Get().Amounts.InternalBattery.Id);

        //        ChoreGroup[] disabled_chore_groups = new ChoreGroup[13]
        //        {
        ...
        //        Trait trait = Db.Get().CreateTrait(PilotRoboConfig.ROVER_BASE_TRAIT_ID, (string)STRINGS.ROBOTS.MODELS.SCOUT.NAME, (string)STRINGS.ROBOTS.MODELS.SCOUT.NAME, (string)null, false, disabled_chore_groups, true, true);
        //        trait.Add(new AttributeModifier(Db.Get().Attributes.Machinery.Id, TUNING.ROBOTS.SCOUTBOT.DIGGING));
        //        trait.Add(new AttributeModifier(Db.Get().Attributes.Athletics.Id, TUNING.ROBOTS.SCOUTBOT.ATHLETICS));
        //        trait.Add(new AttributeModifier(Db.Get().Amounts.HitPoints.maxAttribute.Id, TUNING.ROBOTS.SCOUTBOT.HIT_POINTS));
        //        trait.Add(new AttributeModifier(Db.Get().Amounts.InternalBattery.maxAttribute.Id, 9000f, this.name));
        //        trait.Add(new AttributeModifier(Db.Get().Amounts.InternalBattery.deltaAttribute.Id, -17.14286f, this.name));
        //        placedEntity.AddOrGet<AttributeConverters>();
        //        GridVisibility gridVisibility = placedEntity.AddOrGet<GridVisibility>();
        //        gridVisibility.radius = 30;
        //        gridVisibility.innerRadius = 20f;
        //        placedEntity.AddOrGet<Worker>();
        //        placedEntity.AddOrGet<Effects>();
        //        placedEntity.AddOrGet<AnimEventHandler>();
        //        placedEntity.AddOrGet<Health>();
        //        MoverLayerOccupier moverLayerOccupier = placedEntity.AddOrGet<MoverLayerOccupier>();
        ...
        //        placedEntity.AddOrGetDef<CreatureDebugGoToMonitor.Def>();
        //        placedEntity.AddOrGetDef<RobotAi.Def>();
        ...
        //        EntityTemplates.AddCreatureBrain(placedEntity, chore_table, GameTags.Robots.Models.ScoutRover, (string)null);
        //        placedEntity.AddOrGet<KPrefabID>().RemoveTag(GameTags.CreatureBrain);
        //        placedEntity.AddOrGet<KPrefabID>().AddTag(GameTags.DupeBrain);
        ...
        //        navigator.maxProbingRadius = 14;
        //        navigator.sceneLayer = Grid.SceneLayer.Creatures;

        //        placedEntity.AddOrGet<Sensors>();
        ...
        public static GameObject CreateScout(
          string id,
          string name,
          string desc,
          string anim_file)
