...
namespace CritterTraitsReborn.Traits
{
    public static class AllTraits
    {
      ...
      new Tiny()
        ...
        public static bool IsTraitVisibleInUI(Klei.AI.Trait trait) => IsTraitVisibleInUI(trait.Id);
        public static bool IsTraitVisibleInUI(string traitId) => IsSupportedTrait(traitId) || ModAPI.TraitInApiList(traitId);
