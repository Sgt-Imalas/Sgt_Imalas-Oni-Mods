namespace SGTIM_NotificationManager
{
	internal class STRINGS
	{
		public class NOTIFICATION_CONFIG
		{
			...
			{
				public static LocString CATEGORY = global::STRINGS.MISC.NOTIFICATIONS.UNREFRIGERATEDFOOD.NAME + "-" + global::STRINGS.BUILDINGS.PREFABS.LOGICALARM.LOGIC_PORT;
			}
			public class BROKENMACHINE
			{
				public static LocString CATEGORY = global::STRINGS.MISC.NOTIFICATIONS.BROKENMACHINE.NAME + "-" + global::STRINGS.BUILDINGS.PREFABS.LOGICALARM.LOGIC_PORT;
			}
			public class DUPLICANTDIED
			{
				public static LocString CATEGORY = global::STRINGS.MISC.NOTIFICATIONS.DUPLICANTDIED.NAME + "-" + global::STRINGS.BUILDINGS.PREFABS.LOGICALARM.LOGIC_PORT;
			}
			public class CRITTER_STARVATION
			{
				public static LocString CATEGORY = global::STRINGS.CREATURES.STATUSITEMS.STARVING.NOTIFICATION_NAME + "-" + global::STRINGS.BUILDINGS.PREFABS.LOGICALARM.LOGIC_PORT;
			}
			public class ALLERGIES
			{
				public static LocString CATEGORY = global::STRINGS.DUPLICANTS.DISEASES.ALLERGIES.NAME+ "-" + global::STRINGS.BUILDINGS.PREFABS.LOGICALARM.LOGIC_PORT;
			}
		}
	}
}
