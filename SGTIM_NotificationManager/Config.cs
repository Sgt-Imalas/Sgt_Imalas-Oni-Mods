...
namespace SGTIM_NotificationManager
{
	...
	public class Config : SingletonOptions<Config>
	{
		...
		[Option("STRINGS.NOTIFICATION_CONFIG.MUTE_PING", "STRINGS.NOTIFICATION_CONFIG.MUTE_PING_TOOLTIP", "STRINGS.NOTIFICATION_CONFIG.FOODROT.CATEGORY")]
		[JsonProperty]
		public bool MUTE_FOODROT_SOUND { get; set; }  = true;
		[Option("STRINGS.NOTIFICATION_CONFIG.PAUSE_ON_NOTIFICATION", "STRINGS.NOTIFICATION_CONFIG.PAUSE_ON_NOTIFICATION_TOOLTIP", "STRINGS.NOTIFICATION_CONFIG.FOODROT.CATEGORY")]
		[JsonProperty]
		public bool PAUSE_ON_FOODROT { get; set; }
		[Option("STRINGS.NOTIFICATION_CONFIG.ZOOM_ON_NOTIFICATION", "STRINGS.NOTIFICATION_CONFIG.ZOOM_ON_NOTIFICATION_TOOLTIP", "STRINGS.NOTIFICATION_CONFIG.FOODROT.CATEGORY")]
		[JsonProperty]
		public bool PAN_TO_FOODROT { get; set; }


		[Option("STRINGS.NOTIFICATION_CONFIG.MUTE_PING", "STRINGS.NOTIFICATION_CONFIG.MUTE_PING_TOOLTIP", "STRINGS.NOTIFICATION_CONFIG.UNREFRIGERATEDFOOD.CATEGORY")]
		[JsonProperty]
		public bool MUTE_UNREFRIGERATEDFOOD_SOUND { get; set; }
		[Option("STRINGS.NOTIFICATION_CONFIG.PAUSE_ON_NOTIFICATION", "STRINGS.NOTIFICATION_CONFIG.PAUSE_ON_NOTIFICATION_TOOLTIP", "STRINGS.NOTIFICATION_CONFIG.UNREFRIGERATEDFOOD.CATEGORY")]
		[JsonProperty]
		public bool PAUSE_ON_UNREFRIGERATEDFOOD { get; set; }
		[Option("STRINGS.NOTIFICATION_CONFIG.ZOOM_ON_NOTIFICATION", "STRINGS.NOTIFICATION_CONFIG.ZOOM_ON_NOTIFICATION_TOOLTIP", "STRINGS.NOTIFICATION_CONFIG.UNREFRIGERATEDFOOD.CATEGORY")]
		[JsonProperty]
		public bool PAN_TO_UNREFRIGERATEDFOOD { get; set; }


		[Option("STRINGS.NOTIFICATION_CONFIG.MUTE_PING", "STRINGS.NOTIFICATION_CONFIG.MUTE_PING_TOOLTIP", "STRINGS.NOTIFICATION_CONFIG.BROKENMACHINE.CATEGORY")]
		[JsonProperty]
		public bool MUTE_BROKENMACHINE_SOUND { get; set; }
		[Option("STRINGS.NOTIFICATION_CONFIG.PAUSE_ON_NOTIFICATION", "STRINGS.NOTIFICATION_CONFIG.PAUSE_ON_NOTIFICATION_TOOLTIP", "STRINGS.NOTIFICATION_CONFIG.BROKENMACHINE.CATEGORY")]
		[JsonProperty]
		public bool PAUSE_ON_BROKENMACHINE { get; set; }
		[Option("STRINGS.NOTIFICATION_CONFIG.ZOOM_ON_NOTIFICATION", "STRINGS.NOTIFICATION_CONFIG.ZOOM_ON_NOTIFICATION_TOOLTIP", "STRINGS.NOTIFICATION_CONFIG.BROKENMACHINE.CATEGORY")]
		[JsonProperty]
		public bool PAN_TO_BROKENMACHINE { get; set; }


		[Option("STRINGS.NOTIFICATION_CONFIG.MUTE_PING", "STRINGS.NOTIFICATION_CONFIG.MUTE_PING_TOOLTIP", "STRINGS.NOTIFICATION_CONFIG.DUPLICANTDIED.CATEGORY")]
		[JsonProperty]
		public bool MUTE_DUPLICANTDIED_SOUND { get; set; }
		[Option("STRINGS.NOTIFICATION_CONFIG.PAUSE_ON_NOTIFICATION", "STRINGS.NOTIFICATION_CONFIG.PAUSE_ON_NOTIFICATION_TOOLTIP", "STRINGS.NOTIFICATION_CONFIG.DUPLICANTDIED.CATEGORY")]
		[JsonProperty]
		public bool PAUSE_ON_DUPLICANTDIED { get; set; }
		[Option("STRINGS.NOTIFICATION_CONFIG.ZOOM_ON_NOTIFICATION", "STRINGS.NOTIFICATION_CONFIG.ZOOM_ON_NOTIFICATION_TOOLTIP", "STRINGS.NOTIFICATION_CONFIG.DUPLICANTDIED.CATEGORY")]
		[JsonProperty]
		public bool PAN_TO_DUPLICANTDIED { get; set; }


		[Option("STRINGS.NOTIFICATION_CONFIG.MUTE_PING", "STRINGS.NOTIFICATION_CONFIG.MUTE_PING_TOOLTIP", "STRINGS.NOTIFICATION_CONFIG.CRITTER_STARVATION.CATEGORY")]
		[JsonProperty]
		public bool MUTE_CRITTER_STARVATION_SOUND { get; set; } = true;
		[Option("STRINGS.NOTIFICATION_CONFIG.PAUSE_ON_NOTIFICATION", "STRINGS.NOTIFICATION_CONFIG.PAUSE_ON_NOTIFICATION_TOOLTIP", "STRINGS.NOTIFICATION_CONFIG.CRITTER_STARVATION.CATEGORY")]
		[JsonProperty]
		public bool PAUSE_ON_CRITTER_STARVATION { get; set; } = true;
		[Option("STRINGS.NOTIFICATION_CONFIG.ZOOM_ON_NOTIFICATION", "STRINGS.NOTIFICATION_CONFIG.ZOOM_ON_NOTIFICATION_TOOLTIP", "STRINGS.NOTIFICATION_CONFIG.CRITTER_STARVATION.CATEGORY")]
		[JsonProperty]
		public bool PAN_TO_CRITTER_STARVATION { get; set; } = true;


		[Option("STRINGS.NOTIFICATION_CONFIG.MUTE_PING", "STRINGS.NOTIFICATION_CONFIG.MUTE_PING_TOOLTIP", "STRINGS.NOTIFICATION_CONFIG.ALLERGIES.CATEGORY")]
		[JsonProperty]
		public bool MUTE_ALLERGIES_SOUND { get; set; } = true;
		[Option("STRINGS.NOTIFICATION_CONFIG.PAUSE_ON_NOTIFICATION", "STRINGS.NOTIFICATION_CONFIG.PAUSE_ON_NOTIFICATION_TOOLTIP", "STRINGS.NOTIFICATION_CONFIG.ALLERGIES.CATEGORY")]
		[JsonProperty]
		public bool PAUSE_ON_ALLERGIES { get; set; } = true;
		[Option("STRINGS.NOTIFICATION_CONFIG.ZOOM_ON_NOTIFICATION", "STRINGS.NOTIFICATION_CONFIG.ZOOM_ON_NOTIFICATION_TOOLTIP", "STRINGS.NOTIFICATION_CONFIG.ALLERGIES.CATEGORY")]
		[JsonProperty]
		public bool PAN_TO_ALLERGIES { get; set; } = true;
	}
}
