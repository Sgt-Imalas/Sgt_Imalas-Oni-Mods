	...
	public class STRINGS
	{
		...
		public class ITEMS
		{
			public class INDUSTRIAL_PRODUCTS
			{
				...
				{
					public static LocString NAME = global::STRINGS.UI.FormatAsLink("AI Brain", nameof(BrainConfig));
		...
		public class BUILDINGS
		{
			...
			public class PREFABS
			{
				...
				{
					public static LocString NAME = global::STRINGS.UI.FormatAsLink("AI Control Module [DEPRECATED]", nameof(AIMODULE));
				...
				{
					public static LocString NAME = global::STRINGS.UI.FormatAsLink("AI Nosecone", nameof(RR_AINOSECONE));
				...
				{
					public static LocString NAME = global::STRINGS.UI.FormatAsLink("AI Control Module", nameof(RR_EARLYGAMEAICONTROLMODULE));
				...
				{
					public static LocString NAME = global::STRINGS.UI.FormatAsLink("AI Brain Module [OLD]", nameof(RR_AINOSECONE));
				...
				{
					public static LocString NAME = global::STRINGS.UI.FormatAsLink("AI Brain Module", nameof(RR_AINOSECONE));
					public static LocString DESC = "Piloting is fun, even for an artificial brain!";
					public static LocString EFFECT = "Requires a " + MISC.TAGS.RR_SPACEBRAINFLYER + " to function.\nBrains can be made at the " + global::STRINGS.BUILDINGS.PREFABS.SUPERMATERIALREFINERY.NAME + "\nA brain will pilot the rocket and slowly gain piloting experience, resulting in faster flight times.\n\nFunctions as a Command Module.\n\nOne Command Module may be installed per rocket.\n\nWon't allow any duplicants inside";
				}
				public class RR_AICONTROLMODULE
				{
					...
					public static LocString NAME = global::STRINGS.UI.FormatAsLink("AI Control Module [DEPRECATED]", nameof(AIControlModuleConfig));
					public static LocString DESC = "[Module Deprecated]\nPlease replace with one of the new Modules";
					public static LocString EFFECT = "[Module Deprecated]\nPlease replace with one of the new Modules";
				}
			}
		...
		public class RESEARCH
		{
			...
			public class TECHS
			{
				...
				{
					public static LocString NAME = global::STRINGS.UI.FormatAsLink("Artificial Learning Capabilities", nameof(RR_BRAINMODULETECH));
		...
		public class BUILDING
		{
			public class STATUSITEMS
			{
				public class RR_BRAINEXPERIENCE
				{
					...
					public static LocString LVLNONE = global::STRINGS.UI.FormatAsLink("Automated Pilot", nameof(LVLNONE));
					public static LocString LVL1 = global::STRINGS.UI.FormatAsLink("Novice Pilot", nameof(LVL1));
					public static LocString LVL2 = global::STRINGS.UI.FormatAsLink("Advanced Beginner Pilot", nameof(LVL2));
					public static LocString LVL3 = global::STRINGS.UI.FormatAsLink("Competent Pilot", nameof(LVL3));
					public static LocString LVL4 = global::STRINGS.UI.FormatAsLink("Proficient Pilot", nameof(LVL4));
					public static LocString LVL5 = global::STRINGS.UI.FormatAsLink("Expert Pilot", nameof(LVL5));
					public static LocString LVL6 = global::STRINGS.UI.FormatAsLink("Master Pilot", nameof(LVL6));
				}
