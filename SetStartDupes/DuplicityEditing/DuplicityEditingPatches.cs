...
{
    internal class DuplicityEditingPatches
    {
        public static List<Effect> VanillaDupeEffects = new List<Effect>();
        /// <summary>
        /// Grep all vanilla effects before critter effects get added to the effect set
        /// </summary>
        [HarmonyPatch(typeof(ModifierSet), nameof(ModifierSet.CreateCritteEffects))]
        public class GrepVanillaEffects
        {
            public static void Prefix(ModifierSet __instance)
            {
                VanillaDupeEffects = new List<Effect>(__instance.effects.resources);   
            }
        }
