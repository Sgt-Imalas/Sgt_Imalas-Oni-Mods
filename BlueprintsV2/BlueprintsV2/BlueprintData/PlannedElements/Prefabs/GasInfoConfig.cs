...
{
	internal class GasInfoConfig : CommonPlacerConfig, IEntityConfig
	{
		public static string ID = "BlueprintsV2_Gas_Placer";
		...
		public GameObject CreatePrefab()
		{
			...
			prefab.AddOrGet<ElementOnlyFilterable>().filterElementState = Filterable.ElementState.Gas;
