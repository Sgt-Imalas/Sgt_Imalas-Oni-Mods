...
namespace BlueprintsV2.BlueprintsV2.UnityUI.Components
{
    internal class BlueprintElementEntry : KMonoBehaviour
    {
        ...
        public override void OnPrefabInit()
        {
            ...
            {
                init = true;
                SgtLogger.l("AAAAAAAAAAAAAAAAAAAAAAA");
            ...
            if (SelectedAndCategory != null)
            {
                ...
                if (ModAssets.IsStaticTag(selectedTag, out string name, out string desc, out Sprite sprite))
                {
                    ElementName?.SetText(name);
                    UIUtils.AddSimpleTooltipToObject(this.gameObject, desc);
                ...
                else
                {
                    ...
                    if (prefab != null)
                    {
                        ...
                        UIUtils.AddSimpleTooltipToObject(this.gameObject, GameUtil.GetMaterialTooltips(selectedTag));
                    }
                    else
                    {
