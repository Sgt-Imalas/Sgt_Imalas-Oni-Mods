...
{
	internal class StaterpillarPurpleGeneratorConfig : IBuildingConfig
	{
		public static readonly string ID = "StaterpillarPurpleGenerator";
		...
		public override BuildingDef CreateBuildingDef()
		{
			...
			BuildingDef obj = BuildingTemplates.CreateBuildingDef(construction_mass: BUILDINGS.CONSTRUCTION_MASS_KG.TIER3, construction_materials: aLL_METALS, melting_point: 9999f, build_location_rule: BuildLocationRule.OnFoundationRotatable, noise: NOISE_POLLUTION.NOISY.TIER0, id: iD, width: 1, height: 2, anim: "egg_caterpillar_purple_kanim", hitpoints: 1000, construction_time: 10f, decor: BUILDINGS.DECOR.NONE);
			obj.GeneratorWattageRating = 10000f;
			obj.GeneratorBaseCapacity = 30000f;
			obj.ExhaustKilowattsWhenActive = 10f;
			obj.SelfHeatKilowattsWhenActive = 20f;
