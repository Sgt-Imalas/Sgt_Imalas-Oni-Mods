		...
		public class CREATURES
		{
			public class SPECIES
			{
				public class STATERPILLAR
				{
					...
					{
						public static LocString NAME = (LocString)UI.FormatAsLink("Yellow Plug Slug", nameof(STATERPILLAR));
						...
						public static LocString EGG_NAME = (LocString)UI.FormatAsLink("Yellow Slug Egg", nameof(STATERPILLAR));

						public class BABY
						{
							public static LocString NAME = (LocString)UI.FormatAsLink("Yellow Plug Slug", nameof(STATERPILLAR));
							public static LocString DESC = (LocString)("A chubby little Yellow Plug Sluglet.\n\nIn time it will mature into a fully grown " + UI.FormatAsLink("Yellow Plug Slug", nameof(STATERPILLAR)) + ".");
						}
					}
					public class VARIANT_PURPLE
					{
						public static LocString NAME = (LocString)UI.FormatAsLink("Purple Plug Slug", nameof(STATERPILLAR));
						public static LocString DESC = global::STRINGS.CREATURES.SPECIES.STATERPILLAR.DESC+"\nPurple Variants produce the most power of all and yield more power shards on harvest after sufficient growth";
						public static LocString EGG_NAME = (LocString)UI.FormatAsLink("Purple Slug Egg", nameof(STATERPILLAR));

						public class BABY
						{
							public static LocString NAME = (LocString)UI.FormatAsLink("Smog Sluglet", nameof(STATERPILLAR));
							public static LocString DESC = (LocString)("A chubby little Purple Plug Sluglet.\n\nIn time it will mature into a fully grown " + UI.FormatAsLink("Purple Plug Slug", nameof(STATERPILLAR)) + ".");
						}
					}
				}
