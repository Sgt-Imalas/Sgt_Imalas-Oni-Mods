...
namespace RadiatorMod.Buildings
{
    class HabitatMediumRadiator : IBuildingConfig
    {
        ...
        public override BuildingDef CreateBuildingDef()
        {
            ...
            BuildingDef buildingDef = BuildingTemplates.CreateBuildingDef(ID, 5, 4, "rocket_habitat_medium_module_kanim", 1000, 60f, constructionMass, materials, 9999f, BuildLocationRule.Anywhere, none, noise);
